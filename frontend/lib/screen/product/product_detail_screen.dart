...
class _ProductDetailScreenState extends State<ProductDetailScreen> {
  ...
  Widget build(BuildContext context) {
    // Gabungkan gambar utama dengan gambar dari galeri
    final allImages = [
    ...
    return Scaffold(
      // Kita tidak lagi menggunakan AppBar di sini
      body: Stack(
        children: [
                ...
                delegate: SliverChildListDelegate(
                  AnimationConfiguration.toStaggeredList(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 100), // Beri ruang ekstra di bawah
                    ],
                  ),
                ),
              ),
  ...
  // Helper widget untuk bagian info produk
  ...
  // Helper widget untuk tombol bawah yang menetap
