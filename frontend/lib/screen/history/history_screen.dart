...
class _HistoryScreenState extends State<HistoryScreen> {
  ...
  // --- FUNGSI BARU UNTUK MENGELOMPOKKAN PESANAN ---
  Map<String, List<Order>> _groupOrdersByMonth(List<Order> orders) {
    // Gunakan groupBy dari package 'collection'
    final grouped = groupBy(orders, (Order order) {
      // Kelompokkan berdasarkan format "MMMM yyyy" (e.g., "Juni 2025")
      return DateFormat('MMMM yyyy', 'id_ID').format(order.createdAt);
    });
    return grouped;
  }

  // --- FUNGSI BARU UNTUK IKON STATUS ---
                      ...
                      child: FadeInAnimation(
                        child: Column(
                          ...
                          children: [
                            ...
                            // --- DAFTAR PESANAN DI BULAN TERSEBUT ---
                            ...ordersInMonth
  ...
  // --- WIDGET BARU UNTUK SETIAP ITEM PESANAN (TIDAK LAGI PAKAI CARD) ---
