// lib/screens/checkout/select_shipping_screen.dart
import 'package:flutter/material.dart';
import 'order_summary_screen.dart';

// Model sederhana untuk data tiruan kita
...
class _SelectShippingScreenState extends State<SelectShippingScreen> {
  // Data tiruan untuk pilihan pengiriman
  ...
  ShippingOption? _selectedOption; // Untuk menyimpan pilihan user

  @override
  void initState() {
    super.initState();
    // Otomatis pilih opsi pertama sebagai default
